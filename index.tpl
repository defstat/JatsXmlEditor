{**
 * plugins/generic/jatsXmlEditor/index.tpl
 *
 * Copyright (c) 2017 National Documentation Centre
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * Template for Jats XML Editor
 *
 *}
{strip}
{assign var="pageTitle" value="plugins.generic.jatsXmlEditor.displayName"}
...
<p>{translate key="plugins.generic.jatsXmlEditor.descriptionLong"}</p>
...
<table width="100%" class="data">
	<tr valign="top">
		...
		<td width="80%" class="value">
			{plugin_url|assign:"jatsXmlEditorUrl" escape=false}
			...
			{foreach from=$authors key=authorIndex item=author}
				...
				{/foreach}
			{/foreach}
			{form_language_chooser form="submit" url=jatsXmlEditorUrl}
...
<div id="chooseDestination">
	<h3>{translate key="plugins.generic.jatsXmlEditor.chooseDestination"}</h3>

	<p>{translate key="plugins.generic.jatsXmlEditor.chooseDestinationDescription"}</p>
	...
	<table class="data" width="100%">
		<tr valign="top">
			...
			<td colspan="2" class="value" width="95%">{fieldLabel name="destinationUnpublished" key="plugins.generic.jatsXmlEditor.leaveUnpublished"}</td>
		</tr>
		<tr valign="top">
			...
			<td width="20%" class="value">
				{fieldLabel name="destinationIssue" key="plugins.generic.jatsXmlEditor.addToExisting"}
			</td>
			<td class="value">
...
<h3>{translate key="plugins.generic.jatsXmlEditor.submissionData"}</h3>
...
{/if}{* count($supportedSubmissionLocaleNames) == 1 *}
	...
	<div id="submissionFile">
		...
		{else}
		<tr valign="top">
			<td colspan="2" class="nodata">{translate key="plugins.generic.jatsXmlEditor.submissionDescription"}</td>
		</tr>
		{/if}
		</table>
	</div> <!-- /submissionFile -->
...
<input type="submit" class="button" name="createAnother" value="{translate key="plugins.generic.jatsXmlEditor.saveAndCreateAnother"}" />
